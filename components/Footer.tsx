        ...
        <div>
          ...
          <ul className="mt-6 space-y-3 text-sm">
            <li className="flex items-center gap-2">
              ...
              <a href="tel:(469)321-9413" className="transition hover:text-white">(469) 321-9413</a>
            </li>
            <li className="flex items-center gap-2">
              <Mail className="h-4 w-4 text-[#8be28f]" />
              <a href="mailto:ubedashadeco@gmail.com" className="transition hover:text-white">ubedashadeco@gmail.com</a>
            </li>
          </ul>

          <div className="mt-8 flex gap-3">
            <a href="#" aria-label="Website" className="rounded-full border border-white/10 p-2 transition hover:border-[#2E7D32] hover:text-white">
              <Globe2 className="h-4 w-4" />
            </a>
            <a href="#" aria-label="Message" className="rounded-full border border-white/10 p-2 transition hover:border-[#2E7D32] hover:text-white">
              <MessageCircle className="h-4 w-4" />
            </a>
            <a href="#" aria-label="Send message" className="rounded-full border border-white/10 p-2 transition hover:border-[#2E7D32] hover:text-white">
